...
**Date:** 2026-07-27T08:43:49.020Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 101.730375000001ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 118.1 TPS |
| Node-validated (TxValid) | 2000 @ 118.1 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 118.1 TPS |
| Snapshots observed | 251 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **54.444540999998935 / 101.730375000001 / 107.99675000000025 / 159.58516699999927 ms** (n=1201/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 132.40654200000063 / 158.37579200000073 / 187.75804199999948 / 188.0272500000001 ms (n=1201/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 101.730375000001ms ≤ 200ms with 0 invalid txs at 118.1 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native-interleaved/noop-transfer/200tps-10s-40lanes-chained-closed16-snapshot/run-10/summary.json` (under `results/`).
