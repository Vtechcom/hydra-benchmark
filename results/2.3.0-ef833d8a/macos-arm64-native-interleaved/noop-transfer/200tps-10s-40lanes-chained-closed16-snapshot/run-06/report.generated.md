...
**Date:** 2026-07-27T08:41:05.953Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 103.73049999999967ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 117.3 TPS |
| Node-validated (TxValid) | 2000 @ 117.3 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 117.3 TPS |
| Snapshots observed | 250 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **55.615999999999985 / 103.73049999999967 / 117.00362500000028 / 185.86083300000064 ms** (n=1200/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 133.6069580000003 / 149.64283299999988 / 215.81241600000067 / 218.58545800000138 ms (n=1200/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 103.73049999999967ms ≤ 200ms with 0 invalid txs at 117.3 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native-interleaved/noop-transfer/200tps-10s-40lanes-chained-closed16-snapshot/run-06/summary.json` (under `results/`).
