...
**Date:** 2026-07-27T08:35:15.610Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 95.81987499999741ms vs gate ≤ 200ms.
...
| Snapshots observed | 264 |
| Avg tx / snapshot | 7.6 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **43.01075000000128 / 95.81987499999741 / 107.03049999999894 / 129.85570899999948 ms** (n=1232/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 142.4072500000002 / 185.01479199999994 / 203.69183300000077 / 244.985666999999 ms (n=1232/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 95.81987499999741ms ≤ 200ms with 0 invalid txs at 106.7 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-08/summary.json` (under `results/`).
