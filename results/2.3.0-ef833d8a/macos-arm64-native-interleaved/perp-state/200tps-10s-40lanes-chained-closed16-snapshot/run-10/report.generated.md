...
**Date:** 2026-07-27T08:37:33.616Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 108.52637500000128ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 101.9 TPS |
| Node-validated (TxValid) | 2000 @ 101.9 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 101.9 TPS |
| Snapshots observed | 258 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **50.11729100000048 / 108.52637500000128 / 171.09479199999987 / 230.63658300000134 ms** (n=1195/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 150.33629199999996 / 204.50466600000073 / 291.65991700000086 / 295.4953339999993 ms (n=1195/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 108.52637500000128ms ≤ 200ms with 0 invalid txs at 101.9 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-10/summary.json` (under `results/`).
