...
**Date:** 2026-07-27T08:07:59.452Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 100.21662500000093ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 106.7 TPS |
| Node-validated (TxValid) | 2000 @ 106.7 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 106.7 TPS |
| Snapshots observed | 259 |
| Avg tx / snapshot | 7.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **47.45904200000041 / 100.21662500000093 / 111.2308750000011 / 129.3317079999997 ms** (n=1206/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 144.10291599999982 / 195.45470800000112 / 213.74583299999722 / 232.20354099999895 ms (n=1206/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 100.21662500000093ms ≤ 200ms with 0 invalid txs at 106.7 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-05/summary.json` (under `results/`).
