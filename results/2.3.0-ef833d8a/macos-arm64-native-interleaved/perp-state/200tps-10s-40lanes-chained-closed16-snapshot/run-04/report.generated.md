...
**Date:** 2026-07-27T08:07:08.411Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 98.42974999999933ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 106.5 TPS |
| Node-validated (TxValid) | 2000 @ 106.5 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 106.5 TPS |
| Snapshots observed | 259 |
| Avg tx / snapshot | 7.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **49.53995799999939 / 98.42974999999933 / 106.70587499999965 / 127.04249999999956 ms** (n=1212/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 146.61112500000127 / 182.1994169999998 / 213.1808340000007 / 240.19608400000106 ms (n=1212/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 98.42974999999933ms ≤ 200ms with 0 invalid txs at 106.5 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-04/summary.json` (under `results/`).
