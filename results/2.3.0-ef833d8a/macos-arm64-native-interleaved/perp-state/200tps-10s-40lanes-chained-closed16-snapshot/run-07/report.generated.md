...
**Date:** 2026-07-27T08:34:37.650Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 100.44133299999885ms vs gate ≤ 200ms.
...
| Snapshots observed | 258 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **47.592209000000366 / 100.44133299999885 / 117.11554099999921 / 148.0466669999987 ms** (n=1190/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 146.56945900000028 / 193.41412499999933 / 205.39300000000003 / 244.61837500000001 ms (n=1190/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 100.44133299999885ms ≤ 200ms with 0 invalid txs at 108.1 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-07/summary.json` (under `results/`).
