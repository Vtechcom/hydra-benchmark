...
**Date:** 2026-07-27T08:33:46.586Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 102.37229200000002ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 103.6 TPS |
| Node-validated (TxValid) | 2000 @ 103.6 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 103.6 TPS |
| Snapshots observed | 264 |
| Avg tx / snapshot | 7.6 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **49.54066700000112 / 102.37229200000002 / 116.12612500000068 / 172.49404200000026 ms** (n=1199/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 149.015625 / 201.59375 / 221.99854200000118 / 263.45837500000016 ms (n=1199/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 102.37229200000002ms ≤ 200ms with 0 invalid txs at 103.6 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-06/summary.json` (under `results/`).
