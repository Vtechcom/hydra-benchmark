...
**Date:** 2026-07-27T08:36:07.150Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 106.14141700000073ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 104.4 TPS |
| Node-validated (TxValid) | 2000 @ 104.4 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 104.4 TPS |
| Snapshots observed | 256 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **54.54925000000003 / 106.14141700000073 / 133.33037499999955 / 160.9672499999997 ms** (n=1170/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 150.7881669999988 / 204.74424999999974 / 219.23470799999996 / 246.76733299999978 ms (n=1170/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 106.14141700000073ms ≤ 200ms with 0 invalid txs at 104.4 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-09/summary.json` (under `results/`).
