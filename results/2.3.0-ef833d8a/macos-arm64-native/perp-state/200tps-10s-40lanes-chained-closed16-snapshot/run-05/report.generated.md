...
**Date:** 2026-07-27T07:58:17.330Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 96.38837500000045ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 112.3 TPS |
| Node-validated (TxValid) | 2000 @ 112.3 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 112.3 TPS |
| Snapshots observed | 255 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **43.73016699999971 / 96.38837500000045 / 107.44087500000023 / 120.06237499999952 ms** (n=1178/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 141.83266599999843 / 178.7046249999985 / 210.73216599999978 / 259.983083000001 ms (n=1178/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 96.38837500000045ms ≤ 200ms with 0 invalid txs at 112.3 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-05/summary.json` (under `results/`).
