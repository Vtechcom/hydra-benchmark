...
**Date:** 2026-07-27T07:57:27.572Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 97.4340000000011ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 110 TPS |
| Node-validated (TxValid) | 2000 @ 110 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 110 TPS |
| Snapshots observed | 262 |
| Avg tx / snapshot | 7.6 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **43.01916700000038 / 97.4340000000011 / 113.21566600000006 / 133.00904199999968 ms** (n=1188/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 139.1432079999995 / 193.33945900000072 / 203.479083000002 / 203.7622080000001 ms (n=1188/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 97.4340000000011ms ≤ 200ms with 0 invalid txs at 110 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-03/summary.json` (under `results/`).
