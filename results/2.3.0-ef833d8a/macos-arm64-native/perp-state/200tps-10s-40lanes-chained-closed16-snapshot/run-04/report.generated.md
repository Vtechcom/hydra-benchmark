...
**Date:** 2026-07-27T07:57:53.077Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 97.49354200000016ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 104.7 TPS |
| Node-validated (TxValid) | 2000 @ 104.7 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 104.7 TPS |
| Snapshots observed | 258 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **46.345541999999114 / 97.49354200000016 / 111.60541599999851 / 134.9222910000026 ms** (n=1241/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 146.38041599999997 / 182.97883399999955 / 212.61874999999964 / 225.11704199999986 ms (n=1241/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 97.49354200000016ms ≤ 200ms with 0 invalid txs at 104.7 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-04/summary.json` (under `results/`).
