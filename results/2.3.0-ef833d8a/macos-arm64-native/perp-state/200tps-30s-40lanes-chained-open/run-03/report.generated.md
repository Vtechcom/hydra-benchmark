...
**Date:** 2026-07-27T07:15:05.904Z

**Decision:** **GATE FAIL** — gated on **txvalid** steady P95 = 17638.070750000006ms vs gate ≤ 200ms.
...
| Offered (submit) | 6000 @ 221.7 TPS |
| Node-validated (TxValid) | 5579 @ 206.2 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 900 @ 33.3 TPS |
| Snapshots observed | 14 |
| Avg tx / snapshot | 64.3 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **10735.130000000001 / 17638.070750000006 / 20346.932125 / 20368.855708000003 ms** (n=3620/5579) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 13758.131667000001 / 40070.61745799999 / 40231.61408299999 / 40267.81 ms (n=900/900) |
| Saturated? | false |
...
❌ **FAIL** — txvalid steady P95 17638.070750000006ms > 200ms. Locate the ceiling via offered-vs-validated above.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/perp-state/200tps-30s-40lanes-chained-open/run-03/summary.json` (under `results/`).
