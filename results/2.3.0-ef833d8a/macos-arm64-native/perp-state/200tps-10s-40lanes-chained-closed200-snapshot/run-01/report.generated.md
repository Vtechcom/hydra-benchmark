...
**Date:** 2026-07-27T07:38:57.371Z

**Decision:** **GATE FAIL** — gated on **txvalid** steady P95 = 637.4041669999988ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 133.3 TPS |
| Node-validated (TxValid) | 2000 @ 133.3 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 133.3 TPS |
| Snapshots observed | 34 |
| Avg tx / snapshot | 58.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **340.6427500000009 / 637.4041669999988 / 669.8501670000005 / 682.3906659999993 ms** (n=1161/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 1303.6754159999982 / 1513.7006249999995 / 1567.9380419999998 / 1598.8979170000002 ms (n=1161/2000) |
| Saturated? | false |
...
❌ **FAIL** — txvalid steady P95 637.4041669999988ms > 200ms. Locate the ceiling via offered-vs-validated above.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed200-snapshot/run-01/summary.json` (under `results/`).
