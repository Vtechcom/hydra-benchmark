...
**Date:** 2026-07-27T07:39:41.959Z

**Decision:** **GATE FAIL** — gated on **txvalid** steady P95 = 653.8356670000012ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 135.4 TPS |
| Node-validated (TxValid) | 2000 @ 135.4 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 135.4 TPS |
| Snapshots observed | 33 |
| Avg tx / snapshot | 60.6 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **367.03208300000006 / 653.8356670000012 / 813.9787089999991 / 839.9173749999991 ms** (n=1178/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 1307.0273340000003 / 1546.5369169999994 / 1697.7433330000003 / 1744.6425409999993 ms (n=1178/2000) |
| Saturated? | false |
...
❌ **FAIL** — txvalid steady P95 653.8356670000012ms > 200ms. Locate the ceiling via offered-vs-validated above.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed200-snapshot/run-03/summary.json` (under `results/`).
