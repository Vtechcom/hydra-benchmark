...
**Date:** 2026-07-27T07:34:00.806Z

**Decision:** **GATE FAIL** — gated on **txvalid** steady P95 = 200.8682090000002ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 111.3 TPS |
| Node-validated (TxValid) | 2000 @ 111.3 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 111.3 TPS |
| Snapshots observed | 120 |
| Avg tx / snapshot | 16.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **120.61562500000036 / 200.8682090000002 / 227.46691699999974 / 250.63929199999984 ms** (n=1190/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 373.3386250000003 / 455.61912499999926 / 515.003666999999 / 576.5682919999999 ms (n=1190/2000) |
| Saturated? | false |
...
❌ **FAIL** — txvalid steady P95 200.8682090000002ms > 200ms. Locate the ceiling via offered-vs-validated above.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed50-snapshot/run-01/summary.json` (under `results/`).
