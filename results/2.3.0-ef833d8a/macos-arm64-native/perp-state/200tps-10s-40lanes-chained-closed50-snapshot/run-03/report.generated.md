...
**Date:** 2026-07-27T07:35:05.017Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 192.1889170000013ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 112.6 TPS |
| Node-validated (TxValid) | 2000 @ 112.6 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 112.6 TPS |
| Snapshots observed | 120 |
| Avg tx / snapshot | 16.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **119.95570800000132 / 192.1889170000013 / 226.23279099999854 / 273.88787500000035 ms** (n=1201/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 365.41562500000146 / 449.32950000000164 / 473.8703750000004 / 500.5107910000006 ms (n=1201/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 192.1889170000013ms ≤ 200ms with 0 invalid txs at 112.6 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed50-snapshot/run-03/summary.json` (under `results/`).
