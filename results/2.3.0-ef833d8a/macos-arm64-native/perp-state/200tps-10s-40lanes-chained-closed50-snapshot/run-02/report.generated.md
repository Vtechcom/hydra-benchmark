...
**Date:** 2026-07-27T07:34:40.781Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 181.3209999999999ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 115.9 TPS |
| Node-validated (TxValid) | 2000 @ 115.9 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 115.9 TPS |
| Snapshots observed | 120 |
| Avg tx / snapshot | 16.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **115.4565419999999 / 181.3209999999999 / 211.96316600000137 / 232.36954200000037 ms** (n=1214/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 354.29299999999967 / 434.1967079999995 / 452.91270799999984 / 480.1270000000004 ms (n=1214/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 181.3209999999999ms ≤ 200ms with 0 invalid txs at 115.9 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed50-snapshot/run-02/summary.json` (under `results/`).
