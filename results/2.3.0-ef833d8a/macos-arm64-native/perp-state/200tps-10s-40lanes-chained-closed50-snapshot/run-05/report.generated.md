...
**Date:** 2026-07-27T07:35:53.291Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 188.12429200000042ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 113.9 TPS |
| Node-validated (TxValid) | 2000 @ 113.9 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 113.9 TPS |
| Snapshots observed | 120 |
| Avg tx / snapshot | 16.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **115.79070800000045 / 188.12429200000042 / 240.5332499999986 / 264.33787499999926 ms** (n=1201/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 360.7728329999991 / 451.3424159999995 / 494.9990830000006 / 548.4287920000006 ms (n=1201/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 188.12429200000042ms ≤ 200ms with 0 invalid txs at 113.9 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed50-snapshot/run-05/summary.json` (under `results/`).
