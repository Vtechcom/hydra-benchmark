...
**Date:** 2026-07-27T07:35:29.285Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 191.31624999999985ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 112.9 TPS |
| Node-validated (TxValid) | 2000 @ 112.9 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 112.9 TPS |
| Snapshots observed | 120 |
| Avg tx / snapshot | 16.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **118.16270900000018 / 191.31624999999985 / 211.90041699999983 / 258.13433299999997 ms** (n=1201/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 367.088375000003 / 451.87991599999987 / 476.99891600000046 / 491.10570800000096 ms (n=1201/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 191.31624999999985ms ≤ 200ms with 0 invalid txs at 112.9 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed50-snapshot/run-04/summary.json` (under `results/`).
