...
**Date:** 2026-07-27T06:58:39.588Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 16.825917000000118ms vs gate ≤ 200ms.
...
| Avg tx / snapshot | 1 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **7.359583999999813 / 16.825917000000118 / 22.128249999999753 / 22.128249999999753 ms** (n=72/120) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 26.45270900000014 / 37.43737500000043 / 40.62254099999973 / 40.62254099999973 ms (n=72/120) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 16.825917000000118ms ≤ 200ms with 0 invalid txs at 20.1 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/noop-transfer/20tps-6s-40lanes-chained-open/run-02/summary.json` (under `results/`).
