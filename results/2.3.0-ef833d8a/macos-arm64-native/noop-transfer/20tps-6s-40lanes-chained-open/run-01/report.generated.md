...
**Date:** 2026-07-27T06:58:18.046Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 14.444707999999991ms vs gate ≤ 200ms.
...
| Avg tx / snapshot | 1 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **7.341666000000259 / 14.444707999999991 / 17.124624999999924 / 17.124624999999924 ms** (n=72/120) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 26.33708400000023 / 36.39637499999981 / 39.00929199999973 / 39.00929199999973 ms (n=72/120) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 14.444707999999991ms ≤ 200ms with 0 invalid txs at 20.2 TPS offered.
...
Machine-readable summary: `2.3.0-ef833d8a/macos-arm64-native/noop-transfer/20tps-6s-40lanes-chained-open/run-01/summary.json` (under `results/`).
