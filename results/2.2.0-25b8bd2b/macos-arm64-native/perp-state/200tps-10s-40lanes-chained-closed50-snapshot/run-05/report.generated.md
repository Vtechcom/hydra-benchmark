...
**Date:** 2026-07-27T07:38:07.767Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 187.40812499999993ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 109.1 TPS |
| Node-validated (TxValid) | 2000 @ 109.1 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 109.1 TPS |
| Snapshots observed | 118 |
| Avg tx / snapshot | 16.9 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **124.12495800000033 / 187.40812499999993 / 224.77608300000065 / 244.87162499999977 ms** (n=1175/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 386.4058329999989 / 465.6291250000013 / 486.0458340000023 / 505.7472080000007 ms (n=1175/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 187.40812499999993ms ≤ 200ms with 0 invalid txs at 109.1 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed50-snapshot/run-05/summary.json` (under `results/`).
