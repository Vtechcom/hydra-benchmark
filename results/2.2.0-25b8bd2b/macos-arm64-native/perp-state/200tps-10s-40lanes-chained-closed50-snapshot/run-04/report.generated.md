...
**Date:** 2026-07-27T07:37:42.817Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 182.73666699999922ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 108.1 TPS |
| Node-validated (TxValid) | 2000 @ 108.1 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 108.1 TPS |
| Snapshots observed | 120 |
| Avg tx / snapshot | 16.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **119.93824999999924 / 182.73666699999922 / 223.2672500000008 / 240.21941700000025 ms** (n=1207/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 382.6234169999989 / 462.2146249999987 / 483.1886250000007 / 509.97549999999956 ms (n=1207/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 182.73666699999922ms ≤ 200ms with 0 invalid txs at 108.1 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed50-snapshot/run-04/summary.json` (under `results/`).
