...
**Date:** 2026-07-27T07:37:17.783Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 185.1704579999987ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 108.6 TPS |
| Node-validated (TxValid) | 2000 @ 108.6 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 108.6 TPS |
| Snapshots observed | 118 |
| Avg tx / snapshot | 16.9 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **121.93129200000112 / 185.1704579999987 / 211.04575000000114 / 241.83516699999927 ms** (n=1179/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 380.21350000000166 / 462.32700000000114 / 477.00458400000025 / 488.40187499999956 ms (n=1179/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 185.1704579999987ms ≤ 200ms with 0 invalid txs at 108.6 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed50-snapshot/run-03/summary.json` (under `results/`).
