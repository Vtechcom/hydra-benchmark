...
**Date:** 2026-07-27T07:36:52.884Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 190.60304200000064ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 108.2 TPS |
| Node-validated (TxValid) | 2000 @ 108.2 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 108.2 TPS |
| Snapshots observed | 118 |
| Avg tx / snapshot | 16.9 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **122.97337499999958 / 190.60304200000064 / 220.29220899999927 / 238.83654099999876 ms** (n=1182/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 385.18133399999897 / 470.192665999999 / 500.1477500000001 / 522.9501249999994 ms (n=1182/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 190.60304200000064ms ≤ 200ms with 0 invalid txs at 108.2 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed50-snapshot/run-02/summary.json` (under `results/`).
