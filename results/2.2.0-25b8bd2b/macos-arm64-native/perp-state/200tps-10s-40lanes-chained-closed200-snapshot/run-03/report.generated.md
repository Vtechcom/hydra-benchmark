...
**Date:** 2026-07-27T07:41:37.556Z

**Decision:** **GATE FAIL** — gated on **txvalid** steady P95 = 692.3505000000005ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 131.9 TPS |
| Node-validated (TxValid) | 2000 @ 131.9 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 131.9 TPS |
| Snapshots observed | 33 |
| Avg tx / snapshot | 60.6 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **404.132708000001 / 692.3505000000005 / 795.0849170000001 / 833.9253750000007 ms** (n=1178/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 1314.4237080000003 / 1548.8188750000008 / 1603.4456250000003 / 1633.346875000001 ms (n=1178/2000) |
| Saturated? | false |
...
❌ **FAIL** — txvalid steady P95 692.3505000000005ms > 200ms. Locate the ceiling via offered-vs-validated above.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed200-snapshot/run-03/summary.json` (under `results/`).
