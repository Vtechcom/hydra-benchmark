...
**Date:** 2026-07-27T07:41:15.449Z

**Decision:** **GATE FAIL** — gated on **txvalid** steady P95 = 718.5321669999994ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 131.6 TPS |
| Node-validated (TxValid) | 2000 @ 131.6 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 131.6 TPS |
| Snapshots observed | 33 |
| Avg tx / snapshot | 60.6 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **401.99958400000105 / 718.5321669999994 / 761.2702499999996 / 786.540332999999 ms** (n=1177/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 1317.6163749999996 / 1548.1092499999995 / 1594.616666 / 1616.459667000001 ms (n=1177/2000) |
| Saturated? | false |
...
❌ **FAIL** — txvalid steady P95 718.5321669999994ms > 200ms. Locate the ceiling via offered-vs-validated above.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed200-snapshot/run-02/summary.json` (under `results/`).
