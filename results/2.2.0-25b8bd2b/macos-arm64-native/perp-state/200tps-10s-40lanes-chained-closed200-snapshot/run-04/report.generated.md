...
**Date:** 2026-07-27T07:41:59.542Z

**Decision:** **GATE FAIL** — gated on **txvalid** steady P95 = 690.8942910000005ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 133.5 TPS |
| Node-validated (TxValid) | 2000 @ 133.5 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 133.5 TPS |
| Snapshots observed | 32 |
| Avg tx / snapshot | 62.5 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **406.4523339999996 / 690.8942910000005 / 733.6791250000006 / 774.9452089999995 ms** (n=1165/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 1303.2618340000008 / 1552.7042500000007 / 1600.0509169999996 / 1626.9046669999989 ms (n=1165/2000) |
| Saturated? | false |
...
❌ **FAIL** — txvalid steady P95 690.8942910000005ms > 200ms. Locate the ceiling via offered-vs-validated above.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed200-snapshot/run-04/summary.json` (under `results/`).
