...
**Date:** 2026-07-27T07:40:52.951Z

**Decision:** **GATE FAIL** — gated on **txvalid** steady P95 = 679.840166ms vs gate ≤ 200ms.
...
| **TxValid latency (matching) — steady P50/P95/P99/max** | **390.74770799999897 / 679.840166 / 731.6069589999988 / 766.8069169999999 ms** (n=1140/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 1299.9379590000008 / 1526.6902499999997 / 1572.9774579999994 / 1608.880000000001 ms (n=1140/2000) |
| Saturated? | false |
...
❌ **FAIL** — txvalid steady P95 679.840166ms > 200ms. Locate the ceiling via offered-vs-validated above.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed200-snapshot/run-01/summary.json` (under `results/`).
