...
**Date:** 2026-07-27T07:28:28.970Z

**Decision:** **GATE FAIL** — gated on **txvalid** steady P95 = 21552.609666999997ms vs gate ≤ 200ms.
...
| Node-validated (TxValid) | 5329 @ 199.1 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 743 @ 27.8 TPS |
| Snapshots observed | 12 |
| Avg tx / snapshot | 61.9 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **11565.639458000001 / 21552.609666999997 / 21772.332792 / 21861.985915999998 ms** (n=3598/5329) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 13961.585875 / 41587.005666 / 41718.079375 / 41750.192458 ms (n=743/743) |
| Saturated? | false |
...
❌ **FAIL** — txvalid steady P95 21552.609666999997ms > 200ms. Locate the ceiling via offered-vs-validated above.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-30s-40lanes-chained-open/run-01/summary.json` (under `results/`).
