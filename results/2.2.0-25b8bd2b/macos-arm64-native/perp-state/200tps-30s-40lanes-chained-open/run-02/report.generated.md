...
**Date:** 2026-07-27T07:29:37.361Z

**Decision:** **GATE FAIL** — gated on **txvalid** steady P95 = 21009.655708ms vs gate ≤ 200ms.
...
| Offered (submit) | 6000 @ 223.2 TPS |
| Node-validated (TxValid) | 5588 @ 207.9 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 767 @ 28.5 TPS |
| Snapshots observed | 13 |
| Avg tx / snapshot | 59 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **11639.741875 / 21009.655708 / 21530.447667 / 21572.450458 ms** (n=3608/5588) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 13808.743999999999 / 41036.8065 / 41176.687125 / 41207.954333 ms (n=767/767) |
| Saturated? | false |
...
❌ **FAIL** — txvalid steady P95 21009.655708ms > 200ms. Locate the ceiling via offered-vs-validated above.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-30s-40lanes-chained-open/run-02/summary.json` (under `results/`).
