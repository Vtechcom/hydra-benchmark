...
**Date:** 2026-07-27T08:00:35.730Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 105.98529100000087ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 100.3 TPS |
| Node-validated (TxValid) | 2000 @ 100.3 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 100.3 TPS |
| Snapshots observed | 259 |
| Avg tx / snapshot | 7.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **54.488665999999284 / 105.98529100000087 / 122.29729199999929 / 149.69174999999996 ms** (n=1183/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 156.59016599999813 / 207.74275000000125 / 231.33316700000069 / 243.11124999999993 ms (n=1183/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 105.98529100000087ms ≤ 200ms with 0 invalid txs at 100.3 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-05/summary.json` (under `results/`).
