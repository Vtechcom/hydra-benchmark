...
**Date:** 2026-07-27T08:00:08.060Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 97.84370800000033ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 103.1 TPS |
| Node-validated (TxValid) | 2000 @ 103.1 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 103.1 TPS |
| Snapshots observed | 259 |
| Avg tx / snapshot | 7.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **48.03745799999888 / 97.84370800000033 / 106.25158399999964 / 124.29349999999977 ms** (n=1198/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 151.02349999999933 / 196.5253329999996 / 226.8936249999988 / 275.2027079999989 ms (n=1198/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 97.84370800000033ms ≤ 200ms with 0 invalid txs at 103.1 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-04/summary.json` (under `results/`).
