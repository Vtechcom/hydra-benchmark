...
**Date:** 2026-07-27T07:58:50.323Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 95.3473750000012ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 108.8 TPS |
| Node-validated (TxValid) | 2000 @ 108.8 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 108.8 TPS |
| Snapshots observed | 255 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **44.2560829999984 / 95.3473750000012 / 106.05512499999895 / 126.10908299999937 ms** (n=1195/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 145.4150419999969 / 170.1626669999987 / 206.4942919999994 / 237.44995799999924 ms (n=1195/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 95.3473750000012ms ≤ 200ms with 0 invalid txs at 108.8 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-01/summary.json` (under `results/`).
