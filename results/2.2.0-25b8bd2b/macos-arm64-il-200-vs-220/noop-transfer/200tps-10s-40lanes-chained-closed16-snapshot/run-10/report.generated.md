...
**Date:** 2026-07-27T09:58:06.194Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 97.26924999999937ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 122 TPS |
| Node-validated (TxValid) | 2000 @ 122 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 122 TPS |
| Snapshots observed | 251 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **50.30645900000127 / 97.26924999999937 / 103.47624999999971 / 107.06329100000039 ms** (n=1215/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 128.61387500000092 / 141.21204100000068 / 143.82958299999882 / 231.65604200000053 ms (n=1215/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 97.26924999999937ms ≤ 200ms with 0 invalid txs at 122 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-il-200-vs-220/noop-transfer/200tps-10s-40lanes-chained-closed16-snapshot/run-10/summary.json` (under `results/`).
