...
**Date:** 2026-07-27T09:56:05.351Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 100.11695800000052ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 119.2 TPS |
| Node-validated (TxValid) | 2000 @ 119.2 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 119.2 TPS |
| Snapshots observed | 250 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **52.853665999999976 / 100.11695800000052 / 108.84958300000108 / 143.1638750000002 ms** (n=1201/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 130.83024999999907 / 147.76708300000064 / 166.23729099999946 / 169.76991699999962 ms (n=1201/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 100.11695800000052ms ≤ 200ms with 0 invalid txs at 119.2 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-il-200-vs-220/noop-transfer/200tps-10s-40lanes-chained-closed16-snapshot/run-08/summary.json` (under `results/`).
