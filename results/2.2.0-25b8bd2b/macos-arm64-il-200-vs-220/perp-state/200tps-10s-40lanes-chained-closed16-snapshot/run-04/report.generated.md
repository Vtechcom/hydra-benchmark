...
**Date:** 2026-07-27T09:43:37.543Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 105.67733399999997ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 99.8 TPS |
| Node-validated (TxValid) | 2000 @ 99.8 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 99.8 TPS |
| Snapshots observed | 260 |
| Avg tx / snapshot | 7.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **55.867166 / 105.67733399999997 / 121.38870900000074 / 174.80333400000018 ms** (n=1156/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 158.68370799999866 / 206.10029199999917 / 243.98362499999712 / 249.95183299999917 ms (n=1156/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 105.67733399999997ms ≤ 200ms with 0 invalid txs at 99.8 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-il-200-vs-220/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-04/summary.json` (under `results/`).
