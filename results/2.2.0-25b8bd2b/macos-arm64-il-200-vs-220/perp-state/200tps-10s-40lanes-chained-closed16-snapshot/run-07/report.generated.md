...
**Date:** 2026-07-27T09:47:03.220Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 92.56379199999992ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 104.2 TPS |
| Node-validated (TxValid) | 2000 @ 104.2 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 104.2 TPS |
| Snapshots observed | 259 |
| Avg tx / snapshot | 7.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **42.76679200000035 / 92.56379199999992 / 106.20145799999955 / 134.68183299999964 ms** (n=1233/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 142.77612500000032 / 198.4933340000007 / 239.35141699999895 / 246.3327500000014 ms (n=1233/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 92.56379199999992ms ≤ 200ms with 0 invalid txs at 104.2 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-il-200-vs-220/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-07/summary.json` (under `results/`).
