...
**Date:** 2026-07-27T09:44:32.558Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 93.54612500000076ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 107.2 TPS |
| Node-validated (TxValid) | 2000 @ 107.2 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 107.2 TPS |
| Snapshots observed | 258 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **42.529082999999446 / 93.54612500000076 / 105.61774999999761 / 137.1207089999989 ms** (n=1224/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 144.81025000000045 / 186.27916600000026 / 220.60004200000003 / 255.29299999999967 ms (n=1224/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 93.54612500000076ms ≤ 200ms with 0 invalid txs at 107.2 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-il-200-vs-220/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-05/summary.json` (under `results/`).
