...
**Date:** 2026-07-27T09:46:07.934Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 100.41570799999863ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 102.7 TPS |
| Node-validated (TxValid) | 2000 @ 102.7 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 102.7 TPS |
| Snapshots observed | 262 |
| Avg tx / snapshot | 7.6 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **46.298000000000684 / 100.41570799999863 / 109.82058399999914 / 138.12216600000102 ms** (n=1240/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 150.16766700000153 / 198.64766600000075 / 220.31241600000067 / 262.7634170000001 ms (n=1240/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 100.41570799999863ms ≤ 200ms with 0 invalid txs at 102.7 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-il-200-vs-220/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-06/summary.json` (under `results/`).
