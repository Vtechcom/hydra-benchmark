...
**Date:** 2026-07-27T09:48:34.034Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 101.95924999999988ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 100.8 TPS |
| Node-validated (TxValid) | 2000 @ 100.8 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 100.8 TPS |
| Snapshots observed | 258 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **47.62875000000167 / 101.95924999999988 / 114.65279200000077 / 144.92200000000048 ms** (n=1229/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 153.82979199999863 / 193.6487500000003 / 243.786333 / 257.8040829999991 ms (n=1229/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 101.95924999999988ms ≤ 200ms with 0 invalid txs at 100.8 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-il-200-vs-220/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-09/summary.json` (under `results/`).
