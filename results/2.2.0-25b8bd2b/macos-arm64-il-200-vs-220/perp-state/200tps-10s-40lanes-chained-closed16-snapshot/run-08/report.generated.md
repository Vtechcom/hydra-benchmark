...
**Date:** 2026-07-27T09:47:59.857Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 101.2215410000008ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 101.1 TPS |
| Node-validated (TxValid) | 2000 @ 101.1 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 101.1 TPS |
| Snapshots observed | 256 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **49.36275000000023 / 101.2215410000008 / 108.31516700000066 / 117.69325000000026 ms** (n=1211/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 155.0874590000003 / 186.2622910000009 / 220.5494579999995 / 262.0279580000006 ms (n=1211/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 101.2215410000008ms ≤ 200ms with 0 invalid txs at 101.1 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-il-200-vs-220/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-08/summary.json` (under `results/`).
