...
**Date:** 2026-07-27T08:40:43.339Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 103.17545900000005ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 115.3 TPS |
| Node-validated (TxValid) | 2000 @ 115.3 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 115.3 TPS |
| Snapshots observed | 250 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **55.241165999999794 / 103.17545900000005 / 118.93904199999997 / 317.171875 ms** (n=1184/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 135.29674999999952 / 154.22408299999915 / 345.76724999999897 / 350.5022080000017 ms (n=1184/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 103.17545900000005ms ≤ 200ms with 0 invalid txs at 115.3 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native-interleaved/noop-transfer/200tps-10s-40lanes-chained-closed16-snapshot/run-06/summary.json` (under `results/`).
