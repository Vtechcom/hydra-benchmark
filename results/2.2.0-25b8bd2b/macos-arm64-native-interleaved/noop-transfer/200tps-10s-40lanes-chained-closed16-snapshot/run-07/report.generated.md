...
**Date:** 2026-07-27T08:41:27.908Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 95.72383300000001ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 122.2 TPS |
| Node-validated (TxValid) | 2000 @ 122.2 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 122.2 TPS |
| Snapshots observed | 251 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **40.07916600000135 / 95.72383300000001 / 106.77020900000025 / 130.42816700000003 ms** (n=1185/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 128.0270840000003 / 146.17820800000118 / 169.2402090000014 / 196.76937499999985 ms (n=1185/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 95.72383300000001ms ≤ 200ms with 0 invalid txs at 122.2 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native-interleaved/noop-transfer/200tps-10s-40lanes-chained-closed16-snapshot/run-07/summary.json` (under `results/`).
