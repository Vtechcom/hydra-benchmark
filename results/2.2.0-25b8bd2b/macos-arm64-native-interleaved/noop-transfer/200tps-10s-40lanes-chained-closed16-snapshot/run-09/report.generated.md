...
**Date:** 2026-07-27T08:43:26.412Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 100.43979200000103ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 119.5 TPS |
| Node-validated (TxValid) | 2000 @ 119.5 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 119.5 TPS |
| Snapshots observed | 250 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **54.19775000000027 / 100.43979200000103 / 108.42141600000105 / 142.03620899999987 ms** (n=1200/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 132.1252080000013 / 149.29141700000037 / 178.06124999999975 / 179.2161670000005 ms (n=1200/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 100.43979200000103ms ≤ 200ms with 0 invalid txs at 119.5 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native-interleaved/noop-transfer/200tps-10s-40lanes-chained-closed16-snapshot/run-09/summary.json` (under `results/`).
