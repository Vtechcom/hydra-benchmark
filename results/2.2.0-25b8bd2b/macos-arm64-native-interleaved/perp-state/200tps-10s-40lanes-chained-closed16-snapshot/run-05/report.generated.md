...
**Date:** 2026-07-27T08:08:25.130Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 100.72674999999981ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 104.1 TPS |
| Node-validated (TxValid) | 2000 @ 104.1 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 104.1 TPS |
| Snapshots observed | 260 |
| Avg tx / snapshot | 7.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **53.13537499999984 / 100.72674999999981 / 113.00512499999968 / 125.97391699999935 ms** (n=1194/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 150.9117499999993 / 201.42087500000162 / 212.9625419999993 / 242.94437500000095 ms (n=1194/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 100.72674999999981ms ≤ 200ms with 0 invalid txs at 104.1 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-05/summary.json` (under `results/`).
