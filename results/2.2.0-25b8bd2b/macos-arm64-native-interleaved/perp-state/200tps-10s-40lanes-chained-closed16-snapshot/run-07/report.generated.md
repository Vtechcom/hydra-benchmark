...
**Date:** 2026-07-27T08:34:12.528Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 98.35425000000032ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 103.5 TPS |
| Node-validated (TxValid) | 2000 @ 103.5 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 103.5 TPS |
| Snapshots observed | 257 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **47.37341599999854 / 98.35425000000032 / 109.90300000000207 / 121.87991699999839 ms** (n=1218/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 149.7758330000015 / 209.16966700000012 / 220.25770900000134 / 245.78787499999999 ms (n=1218/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 98.35425000000032ms ≤ 200ms with 0 invalid txs at 103.5 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-07/summary.json` (under `results/`).
