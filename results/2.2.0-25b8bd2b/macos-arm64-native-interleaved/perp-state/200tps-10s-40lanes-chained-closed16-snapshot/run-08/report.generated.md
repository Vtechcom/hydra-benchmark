...
**Date:** 2026-07-27T08:35:41.400Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 101.32820900000115ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 104 TPS |
| Node-validated (TxValid) | 2000 @ 104 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 104 TPS |
| Snapshots observed | 259 |
| Avg tx / snapshot | 7.7 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **47.59504200000083 / 101.32820900000115 / 129.1264169999995 / 189.95529200000055 ms** (n=1184/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 150.70712500000081 / 218.24804099999892 / 268.72220800000105 / 269.16070800000125 ms (n=1184/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 101.32820900000115ms ≤ 200ms with 0 invalid txs at 104 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-08/summary.json` (under `results/`).
