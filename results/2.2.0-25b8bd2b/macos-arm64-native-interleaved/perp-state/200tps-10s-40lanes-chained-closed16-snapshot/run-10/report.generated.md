...
**Date:** 2026-07-27T08:37:07.299Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 103.29958299999998ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 102.2 TPS |
| Node-validated (TxValid) | 2000 @ 102.2 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 102.2 TPS |
| Snapshots observed | 262 |
| Avg tx / snapshot | 7.6 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **46.304707999999664 / 103.29958299999998 / 124.9073329999992 / 206.03541699999914 ms** (n=1211/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 147.02933399999893 / 211.92370799999844 / 287.4043339999989 / 287.922083999998 ms (n=1211/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 103.29958299999998ms ≤ 200ms with 0 invalid txs at 102.2 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-10/summary.json` (under `results/`).
