...
**Date:** 2026-07-27T08:05:15.585Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 100.21408300000257ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 100.7 TPS |
| Node-validated (TxValid) | 2000 @ 100.7 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 100.7 TPS |
| Snapshots observed | 258 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **44.67037500000151 / 100.21408300000257 / 108.34541700000045 / 129.56562499999927 ms** (n=1246/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 149.44608300000255 / 184.72270799999933 / 248.96666600000026 / 263.0002910000003 ms (n=1246/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 100.21408300000257ms ≤ 200ms with 0 invalid txs at 100.7 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-02/summary.json` (under `results/`).
