...
**Date:** 2026-07-27T08:33:20.679Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 100.70720900000015ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 103.4 TPS |
| Node-validated (TxValid) | 2000 @ 103.4 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 103.4 TPS |
| Snapshots observed | 258 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **49.10670800000116 / 100.70720900000015 / 112.09574999999859 / 133.86412500000006 ms** (n=1188/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 152.18795900000077 / 208.79049999999916 / 241.61791699999958 / 249.25341599999956 ms (n=1188/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 100.70720900000015ms ≤ 200ms with 0 invalid txs at 103.4 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-06/summary.json` (under `results/`).
