...
**Date:** 2026-07-27T08:36:32.861Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 100.47616699999708ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 104.6 TPS |
| Node-validated (TxValid) | 2000 @ 104.6 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 104.6 TPS |
| Snapshots observed | 256 |
| Avg tx / snapshot | 7.8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **47.03599999999642 / 100.47616699999708 / 109.83887500000128 / 120.70858300000054 ms** (n=1183/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 154.11812499999905 / 196.5296249999992 / 233.2776249999988 / 248.27808299999924 ms (n=1183/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 100.47616699999708ms ≤ 200ms with 0 invalid txs at 104.6 TPS offered.
...
Machine-readable summary: `2.2.0-25b8bd2b/macos-arm64-native-interleaved/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-09/summary.json` (under `results/`).
