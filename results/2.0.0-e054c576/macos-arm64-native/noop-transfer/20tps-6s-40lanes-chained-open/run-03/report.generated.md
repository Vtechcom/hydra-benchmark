...
**Date:** 2026-07-27T07:15:32.581Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 17.39716700000008ms vs gate ≤ 200ms.
...
| Avg tx / snapshot | 1 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **7.441915999999765 / 17.39716700000008 / 19.09537500000033 / 19.09537500000033 ms** (n=72/120) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 25.96137499999986 / 41.439000000000306 / 48.52929099999983 / 48.52929099999983 ms (n=72/120) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 17.39716700000008ms ≤ 200ms with 0 invalid txs at 20.2 TPS offered.
...
Machine-readable summary: `2.0.0-e054c576/macos-arm64-native/noop-transfer/20tps-6s-40lanes-chained-open/run-03/summary.json` (under `results/`).
