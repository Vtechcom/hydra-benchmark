...
**Date:** 2026-07-27T07:07:21.254Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 18.226292000000285ms vs gate ≤ 200ms.
...
| Avg tx / snapshot | 1 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **7.437167000000045 / 18.226292000000285 / 22.924499999999625 / 22.924499999999625 ms** (n=72/120) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 26.763582999999926 / 38.07141599999977 / 44.723957999999584 / 44.723957999999584 ms (n=72/120) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 18.226292000000285ms ≤ 200ms with 0 invalid txs at 20.1 TPS offered.
...
Machine-readable summary: `2.0.0-e054c576/macos-arm64-native/noop-transfer/20tps-6s-40lanes-chained-open/run-01/summary.json` (under `results/`).
