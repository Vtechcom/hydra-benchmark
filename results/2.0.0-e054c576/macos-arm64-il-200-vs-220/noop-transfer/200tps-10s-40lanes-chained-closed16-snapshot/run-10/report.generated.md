...
**Date:** 2026-07-27T09:57:44.270Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 103.41187499999978ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 116.3 TPS |
| Node-validated (TxValid) | 2000 @ 116.3 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 116.3 TPS |
| Snapshots observed | 250 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **55.88645800000086 / 103.41187499999978 / 111.55895799999962 / 146.90016699999978 ms** (n=1200/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 134.59729199999947 / 152.0176250000004 / 191.8837080000012 / 192.08200000000033 ms (n=1200/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 103.41187499999978ms ≤ 200ms with 0 invalid txs at 116.3 TPS offered.
...
Machine-readable summary: `2.0.0-e054c576/macos-arm64-il-200-vs-220/noop-transfer/200tps-10s-40lanes-chained-closed16-snapshot/run-10/summary.json` (under `results/`).
