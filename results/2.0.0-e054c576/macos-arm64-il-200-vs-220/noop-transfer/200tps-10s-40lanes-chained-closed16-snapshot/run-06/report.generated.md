...
**Date:** 2026-07-27T09:54:58.130Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 104.5625ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 115.6 TPS |
| Node-validated (TxValid) | 2000 @ 115.6 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 115.6 TPS |
| Snapshots observed | 250 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **56.15700000000106 / 104.5625 / 117.22299999999996 / 160.23358299999927 ms** (n=1200/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 135.23799999999937 / 152.92962499999885 / 194.29362500000025 / 196.29308299999866 ms (n=1200/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 104.5625ms ≤ 200ms with 0 invalid txs at 115.6 TPS offered.
...
Machine-readable summary: `2.0.0-e054c576/macos-arm64-il-200-vs-220/noop-transfer/200tps-10s-40lanes-chained-closed16-snapshot/run-06/summary.json` (under `results/`).
