...
**Date:** 2026-07-27T09:56:59.441Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 102.87033300000076ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 116.6 TPS |
| Node-validated (TxValid) | 2000 @ 116.6 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 116.6 TPS |
| Snapshots observed | 250 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **55.96445800000038 / 102.87033300000076 / 109.98474999999962 / 133.14933400000064 ms** (n=1200/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 135.05808400000024 / 151.25224999999955 / 174.31529200000114 / 183.2130419999994 ms (n=1200/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 102.87033300000076ms ≤ 200ms with 0 invalid txs at 116.6 TPS offered.
...
Machine-readable summary: `2.0.0-e054c576/macos-arm64-il-200-vs-220/noop-transfer/200tps-10s-40lanes-chained-closed16-snapshot/run-09/summary.json` (under `results/`).
