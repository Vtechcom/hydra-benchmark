...
**Date:** 2026-07-27T09:44:07.307Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 120.09558300000026ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 86.3 TPS |
| Node-validated (TxValid) | 2000 @ 86.3 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 86.3 TPS |
| Snapshots observed | 251 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **61.83904199999961 / 120.09558300000026 / 134.9177920000002 / 180.3300420000014 ms** (n=1185/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 183.24012500000026 / 234.7710420000003 / 278.75987499999974 / 282.6277090000003 ms (n=1185/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 120.09558300000026ms ≤ 200ms with 0 invalid txs at 86.3 TPS offered.
...
Machine-readable summary: `2.0.0-e054c576/macos-arm64-il-200-vs-220/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-04/summary.json` (under `results/`).
