...
**Date:** 2026-07-27T09:41:37.350Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 128.2970830000013ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 85.8 TPS |
| Node-validated (TxValid) | 2000 @ 85.8 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 85.8 TPS |
| Snapshots observed | 250 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **77.24858300000051 / 128.2970830000013 / 140.2777499999993 / 162.82849999999962 ms** (n=1184/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 185.78412500000013 / 211.1245830000007 / 265.6187089999985 / 266.195416999999 ms (n=1184/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 128.2970830000013ms ≤ 200ms with 0 invalid txs at 85.8 TPS offered.
...
Machine-readable summary: `2.0.0-e054c576/macos-arm64-il-200-vs-220/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-02/summary.json` (under `results/`).
