...
**Date:** 2026-07-27T09:45:40.780Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 126.80795800000124ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 85.6 TPS |
| Node-validated (TxValid) | 2000 @ 85.6 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 85.6 TPS |
| Snapshots observed | 250 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **74.40095800000017 / 126.80795800000124 / 136.7124590000003 / 153.38012499999968 ms** (n=1184/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 186.28891699999986 / 208.71791699999812 / 232.38616700000057 / 232.86770899999829 ms (n=1184/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 126.80795800000124ms ≤ 200ms with 0 invalid txs at 85.6 TPS offered.
...
Machine-readable summary: `2.0.0-e054c576/macos-arm64-il-200-vs-220/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-06/summary.json` (under `results/`).
