...
**Date:** 2026-07-27T09:40:41.414Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 86.77662500000042ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 86.6 TPS |
| Node-validated (TxValid) | 2000 @ 86.6 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 86.6 TPS |
| Snapshots observed | 251 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **55.65104199999769 / 86.77662500000042 / 100.02599999999984 / 144.70570899999802 ms** (n=1209/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 180.3834999999999 / 200.23291699999936 / 237.539249999998 / 240.421875 ms (n=1209/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 86.77662500000042ms ≤ 200ms with 0 invalid txs at 86.6 TPS offered.
...
Machine-readable summary: `2.0.0-e054c576/macos-arm64-il-200-vs-220/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-01/summary.json` (under `results/`).
