...
**Date:** 2026-07-27T09:43:10.821Z

**Decision:** **GATE PASS** — gated on **txvalid** steady P95 = 118.92091700000128ms vs gate ≤ 200ms.
...
| Offered (submit) | 2000 @ 86.8 TPS |
| Node-validated (TxValid) | 2000 @ 86.8 TPS |
| TxInvalid (logic reject — **gated**) | 0 |
| Stale-input race (rig timing — **excluded from gate**) | 0 |
| Confirmed (in snapshot) | 2000 @ 86.8 TPS |
| Snapshots observed | 251 |
| Avg tx / snapshot | 8 |
| **TxValid latency (matching) — steady P50/P95/P99/max** | **60.72650000000067 / 118.92091700000128 / 130.75037499999962 / 148.86775000000125 ms** (n=1191/2000) |
| SnapshotConfirmed latency (settlement) — steady P50/P95/P99/max | 182.73979099999997 / 206.0221249999995 / 245.00424999999996 / 268.6949999999997 ms (n=1191/2000) |
| Saturated? | false |
...
✅ **PASS** — txvalid steady P95 118.92091700000128ms ≤ 200ms with 0 invalid txs at 86.8 TPS offered.
...
Machine-readable summary: `2.0.0-e054c576/macos-arm64-il-200-vs-220/perp-state/200tps-10s-40lanes-chained-closed16-snapshot/run-03/summary.json` (under `results/`).
